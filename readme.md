...
> Hint: think about the DOM.  so use document.xxxxxx
 ...
 2. Create 6 buttons for your letters.  Hard code some letters for now. EX:
    ...
    They should be ***button*** elements and need to have a class attribute added of ***button is-warning m-2***.  

 3. Create an ***ADD*** button with the a class attribute of ***button is-black***

 >NOTE:  YOU WILL NOT SEE THEM YET!!

 ### Step 2

Now that we have the elements available and the buttons in JS, lets first do a 
  1. 
